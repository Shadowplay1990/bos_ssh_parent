...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if (rows.length!=1){
		    ...
		    var url1="${Cxt}/decidedzone_findNotAss";
		    ...
		    var url2="${Cxt}/decidedzone_findAss";
		    var decidedzoneId=rows[0].decidedzoneId;
	...
	var columns = [ [ {
		...
		field : 'staff.cellphone',
		title : '联系电话',
		width : 120,
		align : 'center',
		formatter : function(data,row ,index){
			return row.staff.cellphone;
		}
	}, {
		field : 'staff.station',
		title : '所属公司',
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${Cxt}/decidedzone_queryByPage",
			idField : 'id',
			columns : columns,
	...
	function doDblClickRow(index,data){
		$('#association_subarea').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "subarea_findByDzId?dzId="+data.decidedzoneId,
			columns : [ [{
				field : 'region.id',
				title : '分拣编号',
				width : 120,
				...
				field : 'region.provice',
				title : '省',
				width : 120,
				align : 'center',
				formatter : function(data,row ,index){
					return row.region.provice;
				}
			}, {
				field : 'region.city',
				title : '市',
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "${Cxt}/decidedzone_findAss?decidedzoneId="+data.decidedzoneId,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<script type="text/javascript">
			$(function () {
				$("#save").click(function () {
					var b=$("#addDecidedzoneForm").form("validate");
					if (b){
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addDecidedzoneForm" action="${Cxt}/decidedzone_add">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>定区名称</td>
						<td><input type="text" name="decidedzoneName" class="easyui-validatebox" required="true"/></td>
					</tr>
					<tr>
						<td>选择负责人</td>
						<td>
							<input class="easyui-combobox" name="staff.staffid"
    							data-options="valueField:'staffid',textField:'name',
    							url:'${Cxt}/staff_listAjax'" />
						</td>
					</tr>
					<tr height="300">
						...
						<td>
							<table id="subareaGrid"  class="easyui-datagrid" border="false" style="width:300px;height:300px"
								   data-options="url:'${Cxt}/subarea_listAjax',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
	...
	<div class="easyui-window" title="关联客户窗口" id="customerWindow" collapsible="false" closed="true" minimizable="false" maximizable="false" style="top:20px;left:200px;width: 400px;height: 300px;">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="customerForm" action="${Cxt}/decidedzone_ass" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
