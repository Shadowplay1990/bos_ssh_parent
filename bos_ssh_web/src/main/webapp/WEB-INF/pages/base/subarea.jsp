...
<script type="text/javascript">
	...
	function doExport(){
		window.location.href="${Cxt}/subarea_exportExcel";
	}
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addRegionForm" action="subarea_addSubarea" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>起始号</td>
						<td><input type="text" name="startcode" class="easyui-validatebox" required="true"/></td>
					</tr>
					<tr>
						<td>终止号</td>
						<td><input type="text" name="endcode" class="easyui-validatebox" required="true"/></td>
					</tr>
					<tr>
						<td>单双号</td>
						<td>
							<select class="easyui-combobox" name="singlecode" style="width:150px;">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="searchForm">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>省</td>
						<td><input type="text" name="region.provice"/></td>
					</tr>
					<tr>
						<td>市</td>
					...
					<tr>
						<td>区（县）</td>
						<td><input type="text" name="region.area"/></td>
					</tr>
					<tr>
						<td>关键字</td>
