...
<title>BOS主界面</title>
	...
	<!-- 导入ztree类库 -->
	<link rel="stylesheet"
		  href="${Cxtstatic }/js/ztree/zTreeStyle.css"
		  type="text/css" />
	<script
			src="${Cxtstatic }/js/ztree/jquery.ztree.all-3.5.js"
		...
		$("#btnEp").click(function(){
			...
			if (b){
			    ...
			    if(newPwd==rePwd){
			        ...
			        $.messager.alert("信息提示","两次密码输入不一致，请重新输入","warning");
				}
			}
		});
	});
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input required="true" data-options="validType:'length[4,12]'" id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input required="true" data-options="validType:'length[4,12]'" id="txtRePass" type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                </table>
				</from>
            </div>
