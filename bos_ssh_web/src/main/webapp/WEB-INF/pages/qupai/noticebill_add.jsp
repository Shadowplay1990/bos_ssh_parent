	...
	<div region="north" style="height:31px;overflow:hidden;" split="false"
		...
		<div class="datagrid-toolbar">
			<a id="save" icon="icon-save" href="#" class="easyui-linkbutton"
				plain="true">新单</a>
			<a id="edit" icon="icon-edit" href="${Cxt}/page_qupai_noticebill.action" class="easyui-linkbutton"
				plain="true">工单操作</a>	
		</div>
	</div>
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="noticebill_addBill" method="post">
					...
					<script type="text/javascript">
						$(function () {
							$("input[name=telephone]").blur(function () {
								var tele=this.value;
								url="noticebill_findByCustomerByTel";
								$.post(url,{"telephone":tele},function (data) {
									if(data!=null){
									    var cId=data.id;
									    var cName=data.name;
                                        ...
                                        $("input[name=customerName]").val(cName);
                                        $("input[name=delegater]").val(cName);
